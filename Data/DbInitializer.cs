    ...
    public class DbInitializer
    {
        public static void Initialize(GameContext db)
        {
            ...
            var skills = new[]
            {
                ...
                new Skill {SkillId = 5, Name = "Weapons"}
            };
            ...
            var characters = new[]
            {
                ...
                new Character
                {
                    ...
                    Name = "Cliff Dickson",
                    Password = "2522",
                    Role = "Space Detective",
                    Story = "Cliff Dickson, Private Dick. Son. Cliff really liked making that joke, but what he needed wasn't jokes--it was answers. What he had was a gun, a drink, a dead captain and a whole lot of trouble. Seems like trouble always followed Cliff around--he'd planned on taking the Exeter as a passenger to be dropped off in the Marlowian sector for a nice vacation, but this night had other plans. Cliff didn't have the title of Space Detective for nothing--he was the best. More importantly, he had to show everyone else that he was the best. Get more pay that way. ... wait, he's getting paid for this, right?",
                    Tips = "You're not great at actually performing ship actions, so look for other stuff to do--you have a lot of information at your fingertips and can easily get more. Try trading information with other players to get leads.",
                    TraitName = "Hard Boiled",
                    TraitDescription = "You fight aliens as if you had Weapons training. You repair stations as if you had Engineering. You start with a small report on every crew member."
                },
                new Character
                {
                    CharacterId = 9,
            ...
            var characterSkills = new[]
            {
                ...
                new CharacterSkill { CharacterSkillId = 6, CharacterId = 3, SkillId = 2 },
                new CharacterSkill { CharacterSkillId = 7, CharacterId = 4, SkillId = 1 },
                new CharacterSkill { CharacterSkillId = 8, CharacterId = 4, SkillId = 3 },
                new CharacterSkill { CharacterSkillId = 9, CharacterId = 5, SkillId = 2 },
                new CharacterSkill { CharacterSkillId = 10, CharacterId = 5, SkillId = 4 },
                new CharacterSkill { CharacterSkillId = 11, CharacterId = 6, SkillId = 4 },
                new CharacterSkill { CharacterSkillId = 12, CharacterId = 6, SkillId = 5 },
                new CharacterSkill { CharacterSkillId = 13, CharacterId = 7, SkillId = 4 },
                new CharacterSkill { CharacterSkillId = 14, CharacterId = 7, SkillId = 1 },
                new CharacterSkill { CharacterSkillId = 15, CharacterId = 8, SkillId = 1 },
                new CharacterSkill { CharacterSkillId = 17, CharacterId = 9, SkillId = 1 },
                new CharacterSkill { CharacterSkillId = 18, CharacterId = 9, SkillId = 2 },
                new CharacterSkill { CharacterSkillId = 19, CharacterId = 10, SkillId = 1 },
                new CharacterSkill { CharacterSkillId = 20, CharacterId = 10, SkillId = 4 },
                new CharacterSkill { CharacterSkillId = 21, CharacterId = 11, SkillId = 5 },
                new CharacterSkill { CharacterSkillId = 22, CharacterId = 11, SkillId = 3 },
                new CharacterSkill { CharacterSkillId = 23, CharacterId = 12, SkillId = 1 },
                new CharacterSkill { CharacterSkillId = 24, CharacterId = 12, SkillId = 4 },
                new CharacterSkill { CharacterSkillId = 25, CharacterId = 13, SkillId = 5 },
                new CharacterSkill { CharacterSkillId = 26, CharacterId = 13, SkillId = 3 },
                new CharacterSkill { CharacterSkillId = 27, CharacterId = 14, SkillId = 5 },
                new CharacterSkill { CharacterSkillId = 28, CharacterId = 14, SkillId = 1 },
                new CharacterSkill { CharacterSkillId = 29, CharacterId = 15, SkillId = 4 },
                new CharacterSkill { CharacterSkillId = 30, CharacterId = 15, SkillId = 3 },
                new CharacterSkill { CharacterSkillId = 31, CharacterId = 16, SkillId = 4 },
                new CharacterSkill { CharacterSkillId = 32, CharacterId = 16, SkillId = 3 },
                new CharacterSkill { CharacterSkillId = 33, CharacterId = 17, SkillId = 2 },
                new CharacterSkill { CharacterSkillId = 34, CharacterId = 17, SkillId = 5 },
            };
            ...
            var objectives = new[]
            {
                ...
                new Objective { ObjectiveId = 12, Title = "Breathe Easy", Description = "Three different rooms hit maximum Life Support capacity at any point during the adventure." },
                ...
                new Objective { ObjectiveId = 16, Title = "Veteran Veterinarian", Description = "End the adventure with less than half the crew being injured. ... dead's OK, though." },
                new Objective { ObjectiveId = 17, Title = "Full Of Horseshit", Description = "No more than one person reports to CentCom about your deep, dark secret." },
                ...
                new Objective { ObjectiveId = 19, Title = "No Acting the Mickey", Description = "End the adventure with at least two players in Lockdown." },
                ...
                new Objective { ObjectiveId = 26, Title = "Tight Run Ship", Description = "At least two of the First Officer, Tactical Officer, and Mawg survive without dying once." },
                ...
                new Objective { ObjectiveId = 28, Title = "Chuck's Testy", Description = "You sabotaged the Matter Replicator. Make sure no more than two people find out." },
                new Objective { ObjectiveId = 29, Title = "Home Cookin'", Description = "Any crew member other than you dies more than 3 times OR Chef succeeds both her objectives." },
                new Objective { ObjectiveId = 30, Title = "Shitcurity", Description = "Half the crew dies at least once at any point during the adventure." },
                new Objective { ObjectiveId = 31, Title = "Superior AI", Description = "You sabotaged the Navigation Systems. Don't let more than two players find out." },
                new Objective { ObjectiveId = 32, Title = "Dogwhistlin'", Description = "You sabotaged the Scanners. Don't let any more than two players find out." },
                new Objective { ObjectiveId = 33, Title = "A Good Boy", Description = "At least two of the Head Chef, Chief Veterinarian, and Atmos Tech survive without dying once." },
                new Objective { ObjectiveId = 34, Title = "Exeter Prime", Description = "Half the crew ends the adventure without having died once." },
                new Objective { ObjectiveId = 35, Title = "No More Heroes", Description = "Nobody dies in the same room as you (not including the Bar)." },
                new Objective { ObjectiveId = 36, Title = "My Brand!", Description = "You sabotaged the Research Lab. Make sure no more than two people find out." },
                new Objective { ObjectiveId = 37, Title = "There Are Four Walls", Description = "The ship has researched \"4D Slip\" and \"Dolomite Plating\" by the end of the adventure." },
                new Objective { ObjectiveId = 38, Title = "Last Seen Alive", Description = "Less than half the crew figures out who killed the captain, but you do." },
                new Objective { ObjectiveId = 39, Title = "Farewell, Virginia", Description = "Less than half the crew figures out who sabotaged the Cryo Pods, but you do." },
                new Objective { ObjectiveId = 40, Title = "The Listening Man", Description = "Less than half the crew figures out who sabotaged the Scanners, but you do." }
            };
            ...
            var characterObjectives = new[]
            {
                ...
                new CharacterObjective {CharacterObjectiveId = 3, CharacterId = 1, ObjectiveId = 18},
                new CharacterObjective {CharacterObjectiveId = 4, CharacterId = 1, ObjectiveId = 36},
                new CharacterObjective {CharacterObjectiveId = 5, CharacterId = 1, ObjectiveId = 37},
                ...
                new CharacterObjective {CharacterObjectiveId = 8, CharacterId = 2, ObjectiveId = 3},
                new CharacterObjective {CharacterObjectiveId = 9, CharacterId = 2, ObjectiveId = 4},
                new CharacterObjective {CharacterObjectiveId = 10, CharacterId = 2, ObjectiveId = 5},
                ...
                new CharacterObjective {CharacterObjectiveId = 13, CharacterId = 3, ObjectiveId = 6},
                new CharacterObjective {CharacterObjectiveId = 14, CharacterId = 3, ObjectiveId = 7},
                new CharacterObjective {CharacterObjectiveId = 15, CharacterId = 3, ObjectiveId = 8},
                ...
                new CharacterObjective {CharacterObjectiveId = 18, CharacterId = 4, ObjectiveId = 9},
                new CharacterObjective {CharacterObjectiveId = 19, CharacterId = 4, ObjectiveId = 10},
                new CharacterObjective {CharacterObjectiveId = 20, CharacterId = 4, ObjectiveId = 11},
                ...
                new CharacterObjective {CharacterObjectiveId = 23, CharacterId = 5, ObjectiveId = 3},
                new CharacterObjective {CharacterObjectiveId = 24, CharacterId = 5, ObjectiveId = 12},
                new CharacterObjective {CharacterObjectiveId = 25, CharacterId = 5, ObjectiveId = 13},
                ...
                new CharacterObjective {CharacterObjectiveId = 28, CharacterId = 6, ObjectiveId = 6},
                new CharacterObjective {CharacterObjectiveId = 29, CharacterId = 6, ObjectiveId = 14},
                new CharacterObjective {CharacterObjectiveId = 30, CharacterId = 6, ObjectiveId = 15},
                ...
                new CharacterObjective {CharacterObjectiveId = 33, CharacterId = 7, ObjectiveId = 9},
                new CharacterObjective {CharacterObjectiveId = 34, CharacterId = 7, ObjectiveId = 16},
                new CharacterObjective {CharacterObjectiveId = 35, CharacterId = 7, ObjectiveId = 17},
                ...
                new CharacterObjective {CharacterObjectiveId = 38, CharacterId = 8, ObjectiveId = 38},
                new CharacterObjective {CharacterObjectiveId = 39, CharacterId = 8, ObjectiveId = 39},
                new CharacterObjective {CharacterObjectiveId = 40, CharacterId = 8, ObjectiveId = 40},
                ...
                new CharacterObjective {CharacterObjectiveId = 43, CharacterId = 9, ObjectiveId = 18},
                new CharacterObjective {CharacterObjectiveId = 44, CharacterId = 9, ObjectiveId = 19},
                new CharacterObjective {CharacterObjectiveId = 45, CharacterId = 9, ObjectiveId = 20},
                ...
                new CharacterObjective {CharacterObjectiveId = 48, CharacterId = 10, ObjectiveId = 21},
                new CharacterObjective {CharacterObjectiveId = 49, CharacterId = 10, ObjectiveId = 22},
                new CharacterObjective {CharacterObjectiveId = 50, CharacterId = 10, ObjectiveId = 23},
                ...
                new CharacterObjective {CharacterObjectiveId = 53, CharacterId = 11, ObjectiveId = 21},
                new CharacterObjective {CharacterObjectiveId = 54, CharacterId = 11, ObjectiveId = 24},
                new CharacterObjective {CharacterObjectiveId = 55, CharacterId = 11, ObjectiveId = 25},

                new CharacterObjective {CharacterObjectiveId = 56, CharacterId = 12, ObjectiveId = 1},
                new CharacterObjective {CharacterObjectiveId = 57, CharacterId = 12, ObjectiveId = 2},
                new CharacterObjective {CharacterObjectiveId = 58, CharacterId = 12, ObjectiveId = 18},
                new CharacterObjective {CharacterObjectiveId = 59, CharacterId = 12, ObjectiveId = 26},
                new CharacterObjective {CharacterObjectiveId = 60, CharacterId = 12, ObjectiveId = 27},
            
                new CharacterObjective {CharacterObjectiveId = 61, CharacterId = 13, ObjectiveId = 1},
                new CharacterObjective {CharacterObjectiveId = 62, CharacterId = 13, ObjectiveId = 2},
                new CharacterObjective {CharacterObjectiveId = 63, CharacterId = 13, ObjectiveId = 6},
                new CharacterObjective {CharacterObjectiveId = 64, CharacterId = 13, ObjectiveId = 28},
                new CharacterObjective {CharacterObjectiveId = 65, CharacterId = 13, ObjectiveId = 29},

                new CharacterObjective {CharacterObjectiveId = 66, CharacterId = 14, ObjectiveId = 1},
                new CharacterObjective {CharacterObjectiveId = 67, CharacterId = 14, ObjectiveId = 2},
                new CharacterObjective {CharacterObjectiveId = 68, CharacterId = 14, ObjectiveId = 3},
                new CharacterObjective {CharacterObjectiveId = 69, CharacterId = 14, ObjectiveId = 21},
                new CharacterObjective {CharacterObjectiveId = 70, CharacterId = 14, ObjectiveId = 30},

                new CharacterObjective {CharacterObjectiveId = 71, CharacterId = 15, ObjectiveId = 1},
                new CharacterObjective {CharacterObjectiveId = 72, CharacterId = 15, ObjectiveId = 2},
                new CharacterObjective {CharacterObjectiveId = 73, CharacterId = 15, ObjectiveId = 9},
                new CharacterObjective {CharacterObjectiveId = 74, CharacterId = 15, ObjectiveId = 31},
                new CharacterObjective {CharacterObjectiveId = 75, CharacterId = 15, ObjectiveId = 6},

                new CharacterObjective {CharacterObjectiveId = 76, CharacterId = 16, ObjectiveId = 1},
                new CharacterObjective {CharacterObjectiveId = 77, CharacterId = 16, ObjectiveId = 2},
                new CharacterObjective {CharacterObjectiveId = 78, CharacterId = 16, ObjectiveId = 3},
                new CharacterObjective {CharacterObjectiveId = 79, CharacterId = 16, ObjectiveId = 32},
                new CharacterObjective {CharacterObjectiveId = 80, CharacterId = 16, ObjectiveId = 33},

                new CharacterObjective {CharacterObjectiveId = 81, CharacterId = 17, ObjectiveId = 1},
                new CharacterObjective {CharacterObjectiveId = 82, CharacterId = 17, ObjectiveId = 2},
                new CharacterObjective {CharacterObjectiveId = 83, CharacterId = 17, ObjectiveId = 18},
                new CharacterObjective {CharacterObjectiveId = 84, CharacterId = 17, ObjectiveId = 34},
                new CharacterObjective {CharacterObjectiveId = 85, CharacterId = 17, ObjectiveId = 35}
            };
            ...
            var attributes = new[]
            {
                ...
                new Attribute { AttributeId = 2, Name = "Battle Stations", Abbreviated = "Battle Stations", SkillId = 5, LocationId = 1, VariableType = VariableType.MultipleChoice },
                new Attribute { AttributeId = 3, Name = "Point Defense Systems", Abbreviated = "Pt Def Systems", SkillId = 5, LocationId = 1, VariableType = VariableType.MultipleChoice },
                new Attribute { AttributeId = 4, Name = "Short Range Scanners", Abbreviated = "Short Range Scan", SkillId = 4, LocationId = 2, VariableType = VariableType.None },
                new Attribute { AttributeId = 5, Name = "Long Range Scanners", Abbreviated = "Long Range Scan", SkillId = 4, LocationId = 2, VariableType = VariableType.MultipleChoice },
                ...
                new Attribute { AttributeId = 14, Name = "Research Lab", Abbreviated = "Research Lab", LocationId = 5, VariableType = VariableType.None },
                ...
                new Attribute { AttributeId = 24, Name = "Fight Aliens", Abbreviated = "Fight Aliens", SkillId = 5, VariableType = VariableType.None },
                new Attribute { AttributeId = 25, Name = "Patch Station", Abbreviated = "Patch Station", VariableType = VariableType.Stations },
                new Attribute { AttributeId = 26, Name = "Repair Station", Abbreviated = "Repair Station", SkillId = 2, VariableType = VariableType.Stations }
            };
            ...
            var drones = new[]
            {
                ...
                {
                    DroneId = 1,
                    Name = "SecurityBot \"Beepsky\"",
                    LocationId = 6,
                    Use = "Defends areas against aliens.",
                    Description =
                        "Automatically kills an alien in their room. Destroyed by aliens if there are no players in the room."
                },
                new Drone
                {
                    DroneId = 2,
                    Name = "RepairBot",
                    LocationId = 3,
                    Use = "Repairs broken substations.",
                    Description =
                        "Automatically repairs the most damaged substation in their room by 1. Destroyed by aliens if there are no players in the room. Cannot repair the Slip Drive."
                },
                new Drone
                {
                    DroneId = 3,
                    Name = "MineBot",
                    LocationId = 7,
                    Use = "Dispatches to an Object In Space in the current sector and mines it.",
                    Description =
                        "Once dispatched, comes back at the end of next turn with minerals (regardless of ship position). Destroyed by alien ships if there are any in the sector."
                }
            };
            ...
            var minerals = new[]
            {
                new Mineral
                {
                    ...
                    Acquired = "Mining",
                    Cost = 1,
                    Use = "Increases Life Support at Atmospherics."
                },
                new Mineral
                {
                    MineralId = 2,
                    Action = "Xenonite",
                    Acquired = "Xenobiology",
                    Cost = 1,
                    Use = "Good for research. Two can be used as a wildcard in any research."
                },
                new Mineral
                {
                    MineralId = 3,
                ...
                new Mineral
                {
                    ...
                    Acquired = "",
                    Cost = 3,
                    Use = "Worth a lot of Space Bucks."
                },
                new Mineral
                {
                    MineralId = 5,
