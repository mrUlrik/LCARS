...
namespace LCARS.Data
{
    public class DbInitializer
    {
        public static void Initialize(GameContext db)
        {
            ...
            var attributes = new[]
            {
                new Attribute { AttributeId = 1, Name = "Helm", SkillId = 3, LocationId = 1, VariableType = VariableType.None},
                new Attribute { AttributeId = 2, Name = "Battle Stations", SkillId = 6, LocationId = 1, VariableType = VariableType.MultipleChoice},
                new Attribute { AttributeId = 3, Name = "Point Defense Systems", SkillId = 6, LocationId = 1, VariableType = VariableType.MultipleChoice},
                new Attribute { AttributeId = 4, Name = "Short Range Scanners", SkillId = 4, LocationId = 2, VariableType = VariableType.None},
                new Attribute { AttributeId = 5, Name = "Long Range Scanners", SkillId = 4, LocationId = 2, VariableType = VariableType.MultipleChoice},
                new Attribute { AttributeId = 6, Name = "Requisition Line", SkillId = 1, LocationId = 2, VariableType = VariableType.None},
                new Attribute { AttributeId = 7, Name = "Mech Bay", SkillId = 2, LocationId = 3, VariableType = VariableType.None},
                new Attribute { AttributeId = 8, Name = "Repair Drone Control", SkillId = 3, LocationId = 3, VariableType = VariableType.Drones},
                new Attribute { AttributeId = 9, Name = "Atmospherics", SkillId = 2, LocationId = 3, VariableType = VariableType.Locations},
                new Attribute { AttributeId = 10, Name = "Slip Drive", LocationId = 3, VariableType = VariableType.None},
                new Attribute { AttributeId = 11, Name = "Auto Doc", LocationId = 4, VariableType = VariableType.None},
                new Attribute { AttributeId = 12, Name = "Crew Records", SkillId = 1, LocationId = 4, VariableType = VariableType.Crew},
                new Attribute { AttributeId = 13, Name = "Cloning Pods", LocationId = 4, VariableType = VariableType.None},
                new Attribute { AttributeId = 14, Name = "Research Lab", SkillId = 4, LocationId = 5, VariableType = VariableType.None},
                new Attribute { AttributeId = 15, Name = "Xenobiology", SkillId = 4, LocationId = 5, VariableType = VariableType.None},
                new Attribute { AttributeId = 16, Name = "Robotics", SkillId = 2, LocationId = 5, VariableType = VariableType.None},
                new Attribute { AttributeId = 17, Name = "Lockdown Station", SkillId = 1, LocationId = 6, VariableType = VariableType.Crew},
                new Attribute { AttributeId = 18, Name = "Security Report", SkillId = 1, LocationId = 6, VariableType = VariableType.Crew},
                new Attribute { AttributeId = 19, Name = "Security Drone Control", SkillId = 3, LocationId = 6, VariableType = VariableType.Drones},
                new Attribute { AttributeId = 20, Name = "Cargo Bay", LocationId = 7, VariableType = VariableType.None},
                new Attribute { AttributeId = 21, Name = "Armory", LocationId = 7, VariableType = VariableType.None},
                new Attribute { AttributeId = 22, Name = "Mining Drone Control", SkillId = 3, LocationId = 7, VariableType = VariableType.Drones},
                new Attribute { AttributeId = 23, Name = "Defend Self", LocationId = 8, VariableType = VariableType.None},
                new Attribute { AttributeId = 24, Name = "Fight Aliens", SkillId = 6, LocationId = 8, VariableType = VariableType.None},
                new Attribute { AttributeId = 25, Name = "Patch Station", LocationId = 8, VariableType = VariableType.None},
                new Attribute { AttributeId = 26, Name = "Repair Station", SkillId = 2, LocationId = 8, VariableType = VariableType.None},
            };
